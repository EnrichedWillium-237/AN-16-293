...
void figHFsides() {
    ...
    fin = new TFile("../data/data_HFtest.root");
    ...
    h1->GetYaxis()->SetRangeUser(-0.038, 0.038);
    h1->Draw();
    ...
    TPaveText * tx1 = new TPaveText(0.74, 0.75, 0.89, 0.86, "NDC");
    SetTPaveTxt(tx1, 22);
    tx1->AddText("#eta_{C} = 0");
    tx1->AddText("20 - 60%");
    tx1->Draw();

    TLegend * leg1 = new TLegend(0.19, 0.18, 0.50, 0.32);
    SetLegend(leg1, 22);
    ...
    c->Print("../figures/figHFtest.pdf","pdf");
    c->Print("../figures/figHFtest.png","png");
